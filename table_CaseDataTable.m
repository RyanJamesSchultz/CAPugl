...
% Äspö HRL.
T(i).Name='Aspo';
T(i).Filename='data/raw/Aspo.mat';
T(i).Mc=-4.9;
T(i).Mk=-4.9;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='SURF1';
T(i).Filename='data/raw/SURF1.mat';
T(i).Mc=-3.5;
T(i).Mk=-3.5;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HF2';
T(i).Filename='data/raw/GTS_HF2.mat';
T(i).Mc=-4.9;
T(i).Mk=-4.9;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HF3';
T(i).Filename='data/raw/GTS_HF3.mat';
T(i).Mc=-4.6;
T(i).Mk=-4.6;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HF5';
T(i).Filename='data/raw/GTS_HF5.mat';
T(i).Mc=-5.0;
T(i).Mk=-5.0;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HF6';
T(i).Filename='data/raw/GTS_HF6.mat';
T(i).Mc=-5.0;
T(i).Mk=-5.0;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HF8';
T(i).Filename='data/raw/GTS_HF8.mat';
T(i).Mc=-4.7;
T(i).Mk=-4.7;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HS1';
T(i).Filename='data/raw/GTS_HS1.mat';
T(i).Mc=-4.1;
T(i).Mk=-4.1;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HS2';
T(i).Filename='data/raw/GTS_HS2.mat';
T(i).Mc=-4.3;
T(i).Mk=-4.3;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HS3';
T(i).Filename='data/raw/GTS_HS3.mat';
T(i).Mc=-5.2;
T(i).Mk=-5.2;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HS4';
T(i).Filename='data/raw/GTS_HS4.mat';
T(i).Mc=-5.0;
T(i).Mk=-5.0;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HS5';
T(i).Filename='data/raw/GTS_HS5.mat';
T(i).Mc=-5.0;
T(i).Mk=-5.0;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
T(i).Name='GTS-HS8';
T(i).Filename='data/raw/GTS_HS8.mat';
T(i).Mc=-4.7;
T(i).Mk=-4.7;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
% UK-PNR1z.
T(i).Name='PNR1z';
T(i).Filename='data/raw/PNR1z.mat';
T(i).Mc=-0.7;
T(i).Mk=-0.5;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
% UK-PNR2.
T(i).Name='PNR2';
T(i).Filename='data/raw/PNR2.mat';
T(i).Mc=-1.0;
T(i).Mk=-0.5;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
% Utah-FORGE 2022.
T(i).Name='FORGE22';
T(i).Filename='data/raw/FORGE2022.mat';
T(i).Mc=-1.2;
T(i).Mk=-1.0;
T(i).dMb=0.1;
T(i).dMd=0.1;
...
% Utah-FORGE 2024.
T(i).Name='FORGE24';
T(i).Filename='/Users/rschultz/Desktop/papers/CAPfr/codes/data/FORGE2024.mat';
T(i).Mc=+0.15;
T(i).Mk=+0.30;
T(i).dMb=0.1;
T(i).dMd=0.1;
